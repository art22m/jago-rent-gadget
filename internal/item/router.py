...
def create_item(item: ItemCreate):
    return Item(
        **{"id": 5, "owner_id": 5, "title": item.title, "description": item.description}
    )
...
def get_items():
    return [
        Item(**{"id": 5, "owner_id": 5, "title": "TITLE", "description": "DESCRIPTION"})
    ]
...
def get_item(item_id: int):
    return Item(
        **{"id": item_id, "owner_id": 5, "title": "TITLE", "description": "DESCRIPTION"}
    )
